...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NOTED] = LAYOUT_split_3x6_5_hlc(KC_NO, KC_RBRC, KC_Z, KC_U, KC_A, KC_Q, KC_P, KC_B, KC_M, KC_L, KC_F, KC_NO, KC_NO, LGUI_T(KC_C), LALT_T(KC_S), LCTL_T(KC_I), LSFT_T(KC_E), KC_O, KC_D, RSFT_T(KC_T), RCTL_T(KC_N), RALT_T(KC_R), RGUI_T(KC_H), KC_NO, KC_NO, KC_V, KC_J, KC_X, KC_Y, KC_MINS, KC_NO, KC_NO, KC_NO, KC_NO, KC_W, KC_G, KC_COMM, KC_DOT, KC_K, KC_NO, TG(7), LT(6,KC_ESC), LT(3,KC_SPC), LT(4,KC_TAB), KC_NO, KC_NO, LT(2,KC_ENT), LT(1,KC_BSPC), LT(5,KC_DEL), KC_NO,KC_MUTE, KC_NO,  KC_NO, KC_NO, KC_NO, KC_MUTE, KC_NO, KC_NO, KC_NO, KC_NO),


    [_MATH] = LAYOUT_split_3x6_5_hlc(KC_NO, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, KC_NO, KC_NO, KC_PPLS, KC_PMNS, KC_PAST, KC_PSLS, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_NO, KC_NO, KC_GT, KC_LT, KC_RPRN, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RPRN, KC_COMM, KC_DOT, KC_NO, KC_NO, KC_NO, KC_ESC, KC_SPC, KC_TAB, KC_NO, KC_NO, KC_ENT, KC_BSPC, KC_DEL, KC_NO, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______),


    [_SYM] = LAYOUT_split_3x6_5_hlc(KC_NO, KC_AT, RALT(KC_2), RALT(KC_3), KC_PERC, KC_EQL, KC_PIPE, RALT(KC_7), KC_CIRC, RALT(KC_EQL), KC_TILD, KC_NO, KC_NO, KC_MINS, RALT(KC_QUOT), RALT(KC_LBRC), KC_ASTR, KC_PSLS, RALT(KC_NUBS), KC_LPRN, RALT(KC_RBRC), RALT(KC_NUHS), KC_NUHS, KC_NO, KC_NO, KC_PLUS, KC_RCBR, KC_UNDS, KC_NUBS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LSFT(KC_NUBS), KC_LT, KC_GT, KC_NO, KC_NO, KC_NO, KC_SLSH, KC_SPC, KC_QUES, KC_NO, KC_NO, KC_ENT, KC_NO, KC_NO, KC_NO, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______),
    ...
    [_NUMBLK] = LAYOUT_split_3x6_5_hlc(KC_NO, KC_NO, KC_7, KC_8, KC_9, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_0, KC_4, KC_5, KC_6, KC_PSLS, KC_NO, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_NO, KC_A, KC_1, KC_2, KC_3, RALT(KC_3), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_DEL, KC_BSPC, KC_ENT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______)
