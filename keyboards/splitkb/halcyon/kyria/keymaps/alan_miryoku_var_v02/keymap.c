...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_5_hlc(KC_QUOT, KC_UNDS, KC_Z, KC_U, KC_A, KC_Q, KC_P, KC_B, KC_M, KC_L, KC_F, KC_NO, KC_SCLN, LGUI_T(KC_C), LALT_T(KC_S), LCTL_T(KC_I), LSFT_T(KC_E), KC_O, KC_D, RSFT_T(KC_T), RCTL_T(KC_N), RALT_T(KC_R), RGUI_T(KC_H), KC_NO, KC_LBRC, KC_V, KC_J, KC_X, KC_Y, KC_MINS, KC_NO, KC_NO, KC_NO, KC_NO, KC_W, KC_G, KC_COMM, KC_DOT, KC_K, KC_NO, KC_NO, LT(6,KC_ESC), LT(3,KC_SPC), LT(4,KC_TAB), KC_NO, KC_NO, LT(1,KC_ENT), LT(2,KC_BSPC), LT(5,KC_DEL), KC_NO,KC_MUTE, KC_NO,  KC_NO, KC_NO, KC_NO, KC_MUTE, KC_NO, KC_NO, KC_NO, KC_NO),



    [1] = LAYOUT_split_3x6_5_hlc(KC_NO, RALT(KC_EQL), RALT(KC_2), RALT(KC_3), KC_PERC, KC_CIRC, KC_NO, RALT(KC_7), KC_RCBR, KC_UNDS, KC_LT, KC_TILD, KC_NO, KC_NUHS, RALT(KC_QUOT), RALT(KC_LBRC), KC_ASTR, KC_PSLS, RALT(KC_NUBS), KC_LPRN, RALT(KC_RBRC), RALT(KC_NUHS), KC_GT, KC_NO, KC_NO, KC_NO, KC_PLUS, KC_AT, KC_MINS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_EQL, KC_MINS, KC_AT, KC_PLUS, KC_NO, KC_PIPE, KC_NO, KC_PMNS, KC_QUES, KC_SPC, KC_NO, KC_NO, KC_ENT, KC_NO, KC_NO, KC_NO, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______),


    [2] = LAYOUT_split_3x6_5_hlc(KC_TAB, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, KC_PEQL, KC_PEQL, KC_PPLS, KC_PMNS, KC_PAST, KC_PSLS, KC_BSPC, KC_TRNS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_COMM, KC_DOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_ESC, KC_SPC, KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______),
