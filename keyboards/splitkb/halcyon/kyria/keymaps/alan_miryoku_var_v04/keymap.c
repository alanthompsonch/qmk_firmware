...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MATH] = LAYOUT_split_3x6_5_hlc(KC_NO, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, KC_PEQL, KC_PEQL, KC_PPLS, KC_PMNS, KC_PAST, KC_PSLS, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_COMM, KC_DOT, KC_NO, KC_NO, KC_TRNS, KC_ESC, KC_SPC, KC_TAB, KC_NO, KC_NO, KC_ENT, KC_BSPC, KC_DEL, KC_NO, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______),


    [_SYM] = LAYOUT_split_3x6_5_hlc(KC_NO, RALT(KC_EQL), RALT(KC_2), RALT(KC_3), KC_PERC, KC_CIRC, KC_TILD, RALT(KC_7), KC_RCBR, KC_UNDS, KC_LT, KC_NO, KC_NO, KC_NUHS, RALT(KC_QUOT), RALT(KC_LBRC), KC_ASTR, KC_PSLS, RALT(KC_NUBS), KC_LPRN, RALT(KC_RBRC), RALT(KC_NUHS), KC_GT, KC_NO, KC_NO, KC_EQL, KC_PLUS, KC_AT, KC_MINS, KC_PIPE, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PMNS, KC_QUES, KC_SPC, KC_NO, KC_NO, KC_ENT, KC_NO, KC_NO, KC_NO, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______),
