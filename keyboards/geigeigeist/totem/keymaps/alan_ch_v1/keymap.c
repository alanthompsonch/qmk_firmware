...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    *                               └─────────┴─────────┴─────────┘└─────────┴─────────┴─────────┘*/
    [_MATH] = LAYOUT(
        //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
                     _______,  KC_7,     KC_8,     KC_9,     KC_EQL,   ALGR(KC_EQL),ALGR(KC_7),S(KC_6),S(KC_0),XXXXXXX,
                     KC_0,     KC_4,     KC_5,     KC_6,     S(KC_7),  ALGR(KC_NUBS),S(KC_NUBS),S(KC_MINS),S(KC_RBRC),KC_NUHS,
          _______,   KC_DOT,   KC_1,     KC_2,     KC_3,     KC_SLSH,   S(KC_1),  KC_NUBS,  KC_COMM,  KC_DOT,   S(KC_3),  KC_BSPC,
...
*/
    ...
    * └─────────────────────────────────────────────────┘      │╰╯╰╯╰╯│
    *           ┌─────────┬─────────┬─────────┬─────────┬──────╨──┐┌──╨──────┬─────────┬─────────┬─────────┬─────────┐
    *   ╌┄┈┈───═╡    -    │    -    │    ü    │    ä    │    à    ││  volup  │    F9   │   F10   │   F11   │   F12   │
    *           ├─────────┼─────────┼─────────┼─────────┼─────────┤├─────────┼─────────┼─────────┼─────────┼─────────┤
    *           │    ç    │    -    │    ù    │    é    │    ö    ││  play   │    F5   │    F6   │    F7   │    F8   │
    * ┌─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┐
    * │ UC_NEXT │    -    │    -    │    -    │    è    │    -    ││  voldwn │    F1   │    F2   │    F3   │    F4   │         │
    * └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┤├─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
    *                               │    -    │    -    │    -    ││    -    │    -    │    -    │
    *                               └─────────┴─────────┴─────────┘└─────────┴─────────┴─────────┘*/
    ...
    [_UML] = LAYOUT(
        //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
                    _______,   _______,  UE,       AE,       A_GRV,     KC_VOLU,  KC_F9,    KC_F10,   KC_F11,   KC_F12,
                    C_EDIL,    _______,  U_GRV,    E_AIGU,   OE,        KC_MPLY,  KC_F5,    KC_F6,    KC_F7,    KC_F8,
        _______,    _______,   _______,  _______,  E_GRV,    _______,   KC_VOLD,  KC_F1,    KC_F2,    KC_F3,    KC_F4,   _______,
                                         _______,  _______,  _______,   _______,  _______,  _______
    ),
